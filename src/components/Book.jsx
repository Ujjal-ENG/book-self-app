...
const Book = ({ data }) => {
  return (
    <div className="overflow-hidden relative duration-300 transition-all transform hover:translate-y-2">
      ...
      />
      <div className="bg-black bg-opacity-75 opacity-0 hover:opacity-100 duration-300 transition-opacity ease-in top-0 bottom-0 text-gray-300 absolute px-6 py-4 rounded-lg flex flex-col">
